...
//	cout << dispatcher.role() << endl;
//	board.get_cities_map().at(City::HoChiMinhCity).research_station = true;
//	dispatcher.fly_direct(City::HoChiMinhCity);
//
...
int main(){
        ...
        Dispatcher dispatcher {board, City::Chicago};
        cout << dispatcher.role() << endl;
        board.get_cities_map().at(City::Chicago).research_station = true;
        dispatcher.take_card(City::HoChiMinhCity);
        dispatcher.fly_direct(City::HoChiMinhCity);
    return 1;
};
